...
class Circle extends Shape {
    ...
    render() {
        return `<svg version="1.1" width="400" height="300" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="100" r="80" fill="${this.shapeColor}"/><text x="150" y="125" fill="${this.textColor}" text-anchor="middle" font-size="60">${this.textContent}</text></svg>`;
    };  
};
...
super(textColor, textContent, shapeColor)
    ...
    render() {
        return `<svg version="1.1" width="400" height="300" xmlns="http://www.w3.org/2000/svg"><polygon points ="150,45 300,300 0,300" fill="${this.shapeColor}"/><text x="150" y="250" fill="${this.textColor}" text-anchor="middle" font-size="60">${this.textContent}</text></svg>`
    };  
};
